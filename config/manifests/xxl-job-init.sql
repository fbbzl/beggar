...
CREATE TABLE `xxl_job_info` (
  ...
  `executor_timeout`          int(11)      NOT NULL DEFAULT '0' COMMENT '任务执行超时时间',
...
INSERT INTO `xxl_job_info`(`id`, `job_group`, `job_desc`, `add_time`, `update_time`, `author`, `alarm_email`,
                           ...
                           `child_jobid`)
VALUES (1, 1, '示例任务', now(), now(), 'XXL', '', 'CRON', '0 0 0 * * ? *',
        'DO_NOTHING', 'FIRST', 'demoJobHandler', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', now(), '');

INSERT INTO `xxl_job_user`(`id`, `username`, `password`, `role`, `permission`)
VALUES (1, 'admin', 'e26e9b13e4c5f1f0f0c1c3a6d8a4f5f6', 1, NULL);
